      ...
      <div class="container">
          <div class="ht-left">
              <div class="mail-service">
                  <i class=" fa fa-envelope"></i> hello.thrift@gmail.com
              </div>
      ...
      <div class="inner-header">
          <div class="row">
              <div class="col-lg-2 col-md-2">
                  <div class="logo">
                      <a href="./index.html">
                          <img src="img/logo_website_thrift.png" alt="" />
                      </a>
                  </div>
              </div>
...
//   utk menampilkan data kalkulasi sebelumnya menggunakan fungsi reduce 
  computed: {
      totalHarga() {
